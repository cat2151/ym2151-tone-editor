...
use crate::models::*;
    ...
    fn test_jump_to_op1_and_increase() {
        ...
        assert_eq!(app.values[0][5], 11, "Value at OP1 column 5 should increase from 10 to 11");
    }
    ...
    fn test_jump_to_op2_and_increase() {
        ...
        // Verify value increased
        assert_eq!(app.values[2][2], 6, "Value at OP2 column 2 should increase from 5 to 6");
    }
    ...
    fn test_jump_to_op3_and_increase() {
        ...
        // Verify value increased
        assert_eq!(app.values[1][1], 21, "Value at OP3 column 1 should increase from 20 to 21");
    }
    ...
    fn test_jump_to_op4_and_increase() {
        ...
        // Verify value increased
        assert_eq!(app.values[3][3], 16, "Value at OP4 column 3 should increase from 15 to 16");
    }
    ...
    fn test_jump_to_op1_and_decrease() {
        ...
        assert_eq!(app.values[0][4], 9, "Value at OP1 column 4 should decrease from 10 to 9");
    }
    ...
    fn test_jump_to_op2_and_decrease() {
        ...
        // Verify value decreased
        assert_eq!(app.values[2][6], 7, "Value at OP2 column 6 should decrease from 8 to 7");
    }
    ...
    fn test_jump_from_ch_row_clamps_cursor_x() {
        ...
        assert_eq!(app.cursor_x, 2, "Cursor column 2 should be valid for operator rows");
